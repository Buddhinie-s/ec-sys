        ...
        <div class="container">
            <div class="row g-5">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$operate == 'update') {
                    ...
                    if (empty($messages)) {
                        $db = dbConn();
                       $sql = "INSERT INTO `tbl_division_office`(`OfficeID`, `EmpID`, `District`, `Location`, `Designation`, `DivisionSecretariName`, `Name` ) VALUES ('$o_OfficeID','$e_EmpID','$name_en','$e_Location','$e_Designation','$e_DistrictSecretariName','$division_name') ";
                        $db->query($sql);
                        $DivisionID = $db->insert_id;
                        echo $sql = "INSERT INTO `tbl_division_office_contact`(`DivisionID`, `Contact`) VALUES('$DivisionID', '$e_Contact1')";
                        $db->query($sql);
                        ?>
                        <script >
                            Swal.fire({
                ...
                <form id="form_division" method = "post" action = "<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" class = "card p-2"  enctype="multipart/form-data">
                    ...
                    <div class = "row g-3">
                        ...
                        <div class = "col-sm-12">
                            <label for = "DistrictSecretariName" class = "form-label">Divisional Secretariat Name with addressing title:<span style="color: red">*</span></label>
