    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
           <div class="btn-group me-2">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary">Emails</button>
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Total :<a href="#" class="card-link">Card link</a></p>
                    <p class="card-text">Workstation information  :<a href="#" class="card-link">Card link</a></p>
                    <p class="card-text">Availability  :<a href="#" class="card-link">Leave</a></p>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card bg-warning bg-opacity-50">
                <div class="card-body">
                    ...
                    <p class="card-text display-1">25</p>
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Today Sales</h6>
                    <p class="card-text display-3">Rs.155000</p>
